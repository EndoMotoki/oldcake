...
class FirstViewController: UIViewController,WKUIDelegate,WKNavigationDelegate,GADBannerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string:"https://gip-home.xmilkyway.com#About")
